...
namespace Movies.Api
{
    public class Startup
    {
        ...
        {
            services.Configure<KeyModel>(Configuration.GetSection("NytApiKey"));
            services.Configure<EndPoints>(Configuration.GetSection("Endpoints"));
            services.Configure<AuthKeyModel>(Configuration.GetSection("AuthKey"));
            ...
            {
                var key = Encoding.ASCII.GetBytes(Configuration["AuthKey:Key"]);
                jwt.SaveToken = true;
